...
const express = require("express"),
  ...
  //listing 22.1 3 modules required
...
//listing 22.1 
router.use(cookieParser("secret_passcode"));  //configure your express.js app to use cookie-parser as middleware
router.use(
  expressSession({
...
router.use(connectFlash()); //configure your app to use connect-flash as middleware
//listing 22.2
